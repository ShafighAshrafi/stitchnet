...
def finetune(
    ...
    """
    Fine-tune model for chest X-ray pneumonia dataset (2 classes: NORMAL, PNEUMONIA).
    ...
    Args:
        ...
        feature_extract: If True, only train the last layer

    Returns:
        Training history (train_acc_history, train_loss_history)
    """
    # The given model should be of type pytorch
